...
:::inset **Tipp:** Wenn du um Hilfe bittest, gib folgende Informationen an:
...
- [Synapse-Dokumentation](https://element-hq.github.io/synapse/latest/) -
  Offizielle Dokumentation für den Synapse-Homeserver
- [Synapse auf GitHub](https://github.com/element-hq/synapse) - Quellcode und
  Issue-Tracker
- [Synapse-Installationsanleitung](https://element-hq.github.io/synapse/latest/setup/installation.html)

### Continuwuity

- [Continuwuity-Website](https://continuwuity.org/) - Offizielle
  Continuwuity-Dokumentation
- [Continuwuity-Repository](https://forgejo.ellis.link/continuwuation/continuwuity) -
  Quellcode und Dokumentation

### Matrix-Spezifikation

- [Matrix-Spezifikation](https://spec.matrix.org/) - Offizielle
...
Verwende dieses Verbindungstest-Tool, um Probleme mit deinem Server zu
diagnostizieren. Es überprüft:
...
Die Testergebnisse können dir helfen, Probleme zu identifizieren und liefern
wertvolle Informationen, wenn du Hilfe suchst.

### Überprüfe die Server-Logs

Überprüfe deine [Server-Logs](/docs/server-logs) auf Fehlermeldungen. Häufige
Probleme haben oft eindeutige Fehlermeldungen, die bei der Diagnose helfen
können.
...
- **Wann das Problem begann**: "Nach dem Update auf Version X" oder
  "Neuinstallation"

### Relevante Logs beifügen

Teile die spezifischen Fehlermeldungen aus deinen Logs, nicht die gesamte
Log-Datei.

:::warning Logs können sensible Informationen wie Benutzer-IDs, IP-Adressen oder
Domainnamen enthalten. Überprüfe und schwärze sensible Daten, bevor du sie
öffentlich teilst. :::
...
- Denke daran, dass Community-Mitglieder ihre Zeit freiwillig zur Verfügung
  stellen
...
Kommerzieller Support wird von verschiedenen Organisationen angeboten. Für eine
aktuelle Liste schau auf der
[Hosting-Seite](https://matrix.org/ecosystem/hosting/) auf der
Matrix.org-Website nach.
...
Hast du einen Fehler in dieser Dokumentation gefunden oder möchtest du sie
verbessern? Beiträge sind willkommen! Schau im Projekt-Repository nach den
Beitragsrichtlinien.
...
- Tritt
  ...
  bei für wöchentliche Updates zum Matrix-Ökosystem
...
- Melde sie an die Sicherheitskontakte:
  ...
  - Continuwuity: [security@continuwuity.org](mailto:security@continuwuity.org)
    oder kontaktiere Mitglieder direkt per E2EE-Privatnachricht:
...
- [Matrix Community](https://matrix.to/#/#community:matrix.org) - Zentrale
  Anlaufstelle für Matrix-Community-Spaces
