...
export default define.page(function ServerLogs(ctx) {
  ...
  return (
    <DocsLayout
      ...
      i18n={i18n}
      title={i18n.tString("docs.server_logs.title")}
      description={i18n.tString("docs.server_logs.description")}
    >
      <div
      ...
      <p class="govuk-body">{i18n.t("docs.server_logs.overview")}</p>
    </DocsLayout>
  );
});
