...
export default define.page(function GettingHelp(ctx) {
  ...
  return (
    <DocsLayout
      ...
      i18n={i18n}
      title={i18n.tString("docs.getting_help.title")}
      description={i18n.tString("docs.getting_help.description")}
    >
      <div
      ...
      <p class="govuk-body">{i18n.t("docs.getting_help.overview")}</p>
    </DocsLayout>
  );
});
