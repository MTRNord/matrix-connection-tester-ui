...
export default define.page(function ServerConfiguration(ctx) {
  ...
  return (
    <DocsLayout
      ...
      i18n={i18n}
      title={i18n.tString("docs.server_configuration.title")}
      description={i18n.tString("docs.server_configuration.description")}
    >
      <div
      ...
      <p class="govuk-body">{i18n.t("docs.server_configuration.overview")}</p>
    </DocsLayout>
  );
});
