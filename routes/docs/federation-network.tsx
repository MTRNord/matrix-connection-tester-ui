...
export default define.page(function FederationNetwork(ctx) {
  ...
  return (
    <DocsLayout
      ...
      i18n={i18n}
      title={i18n.tString("docs.federation_network.title")}
      description={i18n.tString("docs.federation_network.description")}
    >
      <div
      ...
      <p class="govuk-body">{i18n.t("docs.federation_network.overview")}</p>
    </DocsLayout>
  );
});
