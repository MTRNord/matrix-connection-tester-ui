...
export default define.page(function Performance(ctx) {
  ...
  return (
    <DocsLayout
      ...
      i18n={i18n}
      title={i18n.tString("docs.performance.title")}
      description={i18n.tString("docs.performance.description")}
    >
      <div
      ...
      <p class="govuk-body">{i18n.t("docs.performance.overview")}</p>
    </DocsLayout>
  );
});
