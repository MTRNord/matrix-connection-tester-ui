...
export default define.page(function TlsCertificates(ctx) {
  ...
  return (
    <DocsLayout
      ...
      i18n={i18n}
      title={i18n.tString("docs.tls_certificates.title")}
      description={i18n.tString("docs.tls_certificates.description")}
    >
      <div
      ...
      <p class="govuk-body">{i18n.t("docs.tls_certificates.overview")}</p>
    </DocsLayout>
  );
});
