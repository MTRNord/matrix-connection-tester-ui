...
export default define.page(function ClientServerApi(ctx) {
  ...
  return (
    <DocsLayout
      ...
      i18n={i18n}
      title={i18n.tString("docs.client_server_api.title")}
      description={i18n.tString("docs.client_server_api.description")}
    >
      <div
      ...
      <p class="govuk-body">{i18n.t("docs.client_server_api.overview")}</p>
    </DocsLayout>
  );
});
