...
export default define.page(function WellknownDelegation(ctx) {
  ...
  return (
    <DocsLayout
      ...
      i18n={i18n}
      title={i18n.tString("docs.wellknown_delegation.title")}
      description={i18n.tString("docs.wellknown_delegation.description")}
    >
      <div
      ...
      <p class="govuk-body">{i18n.t("docs.wellknown_delegation.overview")}</p>
    </DocsLayout>
  );
});
