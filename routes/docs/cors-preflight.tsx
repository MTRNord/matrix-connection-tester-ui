...
export default define.page(function CorsPreflight(ctx) {
  ...
  return (
    <DocsLayout
      ...
      i18n={i18n}
      title={i18n.tString("docs.cors_preflight.title")}
      description={i18n.tString("docs.cors_preflight.description")}
    >
      <div
      ...
      <p class="govuk-body">{i18n.t("docs.cors_preflight.overview")}</p>
    </DocsLayout>
  );
});
