...
export default define.page(function Troubleshooting(ctx) {
  ...
  return (
    <DocsLayout
      ...
      i18n={i18n}
      title={i18n.tString("docs.troubleshooting.title")}
      description={i18n.tString("docs.troubleshooting.description")}
    >
      <div
      ...
      <p class="govuk-body">{i18n.t("docs.troubleshooting.overview")}</p>
    </DocsLayout>
  );
});
