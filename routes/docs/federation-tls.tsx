...
export default define.page(function FederationTls(ctx) {
  ...
  return (
    <DocsLayout
      ...
      i18n={i18n}
      title={i18n.tString("docs.federation_tls.title")}
      description={i18n.tString("docs.federation_tls.description")}
    >
      <div
      ...
      <p class="govuk-body">{i18n.t("docs.federation_tls.overview")}</p>
    </DocsLayout>
  );
});
